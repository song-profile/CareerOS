...
public class RecruitmentEvent extends BaseTimeEntity {
    ...
    private RecruitmentEvent(User user) {
        this.user = user;
        this.sourceType = EventSourceType.MANUAL;
    ...
    public static RecruitmentEvent createApplicationGenerated(
            User user,
            Application application,
            EventType eventType,
            String title,
        ...
        RecruitmentEvent event = create(
                user, application, eventType, title, startAt, endAt, allDay, location, onlineUrl, memo);
        event.sourceType = EventSourceType.APPLICATION;
    ...
    public void markSynced(String googleEventId) {
        ...
        this.googleSyncedAt = Instant.now();
    }
    ...
    public EventSourceType getSourceType() { return sourceType; }
